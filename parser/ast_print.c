...
/*   Updated: 2025/04/09 20:29:39 by natallia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			printf(CYAN "%s" RESET_COLOR, node->cmd && node->cmd->cmd_name
...
// 			{
// 				printf(" ");
// 				print_assignments(node->cmd->temp_assignments, "Temp Assign");
// 			}

// 			if (node->cmd && node->cmd->perm_assignments)
// 			{
// 				printf(" ");
// 				print_assignments(node->cmd->perm_assignments, "Perm Assign");
// 			}
